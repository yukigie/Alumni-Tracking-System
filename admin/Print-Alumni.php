...
<head>
    ...
    <title>Alumni | Print Alumni</title>
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        <a href="Alumni.php" style="margin-top: -10px; color: #C2AE44"><span><i class='bx bx-chevron-left'></i></span> Return to Alumni List</a>
...
document.getElementById('filter_type').addEventListener('change', function () {
    ...
    document.querySelectorAll('#filter_course, #filter_year, #filter_status, #filter_comp, #filter_place, #filter_income, #submit').forEach(el => {
        el.style.display = 'none';
    });

    if (selectedCategory === 'course') document.getElementById('filter_course').style.display = 'inline-block';
...
document.getElementById('submit').addEventListener('click', function () {
    ...
    if (filterType === 'course') filterValue = document.getElementById('filter_course').value;
