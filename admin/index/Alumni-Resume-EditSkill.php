...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tbl_alumni_skill 
              SET Skill_Name = '{$skills}', 
              Esperience = '{$experience}'
              WHERE ID = '{$skill_id}' AND Email = '{$email}'";
...
if ( isset($_POST['deletedata']) ){
        ...
        $sql = "DELETE FROM tbl_alumni_skill WHERE ID=$skill_id AND Email = '{$email}'";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <form action="Alumni-Resume-EditSkill.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body">
      ...
      <?php
        ...
        if ($id) {
            ...
            $query = "SELECT * FROM tbl_alumni_skill WHERE ID ='$id' AND Email ='$email'";
            $query_run = mysqli_query($con, $query);
            $check_data = mysqli_num_rows($query_run) > 0;
        ...
        <div class="row justify-content-center">
          ...
          <input type="hidden" name="skill_id" id="skill_id" class="form-control" value="<?php echo $row['ID']; ?>" required>

            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 20px;">
                <label>Skill Name*</label>
                <input type="text" id="skills" name="skills" class="form-control" value="<?php echo $row['Skill_Name']; ?>">
              </div>
            </div>
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 10px;">
                ...
                <select name="experience" id="experience" class="form-control" required style="margin-top: 10px;">
                  <option selected hidden><?php echo $row['Esperience']; ?></option>
            ...
            <div class="col-lg-12">
              ...
              <button class="delete-btn1" id="deletedata" name="deletedata" form="form_body">Delete</button>
               ...
               <a href="Alumni-Resume-AddSkill.php"><button class="delete-btn1" style="float: right; background-color: #6C5E19;" type="button" onmouseover="this.style.backgroundColor='#2C5F3D';" 
