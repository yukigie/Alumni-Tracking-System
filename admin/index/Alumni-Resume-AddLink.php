...
if (isset($_POST['submit'])) {
    ...
    // Insert Data
    $query = "INSERT INTO tbl_alumni_link (Link, Email) 
              VALUES ('{$link}', '{$email}')";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <form action="Alumni-Resume-AddLink.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
