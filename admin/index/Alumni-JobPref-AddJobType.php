...
if (isset($_POST['submit'])) {
    ...
    $check = mysqli_query($con, "SELECT * FROM tbl_alumni_jobpreftype WHERE Job_Type='$Job_type' AND Email='$email'");
    
    if (mysqli_num_rows($check) > 0) {
        alert("Already Exist!", "The Job type You Entered Is Already On The List!", "warning");
    } else {

    // Insert Data
    $query = "INSERT INTO tbl_alumni_jobpreftype (Job_Type, Email) 
              VALUES ('{$Job_type}', '{$email}')";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <h5>What are your desired Job Status?</h5>
        <form action="Alumni-JobPref-AddJobType.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 10px;">
                ...
                <select name="Job_type" id="Job_type" class="form-control" required style="margin-top: 10px;">
