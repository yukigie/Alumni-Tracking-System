...
if (isset($_POST['submit'])) {
    ...
    $check = mysqli_query($con, "SELECT * FROM tbl_alumni_jobprefdays WHERE Days='$days' AND Email='$email'");
    ...
    // Insert Data
    $query = "INSERT INTO tbl_alumni_jobprefdays (Days, Email) 
              VALUES ('{$days}', '{$email}')";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <form action="Alumni-JobPref-AddDays.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 10px;">
                <label>Days*</label>
                <select name="days" id="days" class="form-control" required style="margin-top: 10px;">
