...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tbl_alumni_citizen (ID, Citizenship, Email) 
              VALUES ('{$atn}', '{$citizen}', '{$email}')
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <h5>Citizenship<span><i class='bx bxs-edit' ></i></span></h5>
        <form action="Alumni-Resume-Citizen.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
            ...
            ?>
              ...
              <div class="form-group" style="margin-top: 20px;">
                <label style="margin-bottom: 10px;">Citizenship*</label>
                ...
                while($row = mysqli_fetch_assoc($query_run))
                    {
            ?>
                    <option selected hidden><?php echo $row['Citizenship']; ?></option>
