...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tbl_alumni_jobprefsalary (ID, Salary, Email) 
              VALUES ('{$atn}', '{$salary}', '{$email}')
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <h5>What are your desired Salary?</h5>
        <form action="Alumni-JobPref-AddSalary.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
            ...
            ?>
              ...
              <div class="form-group" style="margin-top: 20px;">
                <label style="margin-bottom: 10px;">Salary Range*</label>
