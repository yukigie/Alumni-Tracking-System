...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tbl_alumni_certification 
              SET Certi_Name = '{$certi_name}', 
              From_Month = '{$from_month}', 
              From_Year = '{$from_year}', 
              To_Month = '{$to_month}', 
              To_Year = '{$to_year}', 
              Description = '{$textarea}' 
              WHERE ID = '{$certi_id}' AND Email = '{$email}'";
...
if ( isset($_POST['deletedata']) ){
        ...
        $sql = "DELETE FROM tbl_alumni_certification WHERE ID=$certi_id AND Email = '{$email}'";
        ...
        {
        alert("Data Not Deleted!", "Failed to delete Your Resume Details.", "error");
        }
...
<div class="row">
   ...
   <div id="personal_details" style="padding-top: 0px;">
        ...
        <h5>Certification or License<span><i class='bx bxs-edit' ></i></span></h5>
        <p style="font-size: 13px; color: red;">*Please Fill Out All Fields</p>
        <form action="Alumni-Resume-EditCerti.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
      ...
      <?php
        ...
        if ($id) {
            ...
            $query = "SELECT * FROM tbl_alumni_certification WHERE ID ='$id' AND Email ='$email'";
            $query_run = mysqli_query($con, $query);
            $check_data = mysqli_num_rows($query_run) > 0;
            ...
            echo "<script>alert('No work experience selected!'); window.location.href = 'Alumni-Resume.php';</script>";
            exit;
        }
        ?>
        ...
        <div class="row justify-content-center">
          ...
          <input type="hidden" name="certi_id" id="certi_id" class="form-control" value="<?php echo $row['ID']; ?>" required>

            <div class="col-lg-12">
                <div class="form-group" style="margin-top: 20px;">
                    <label>Certification / License name*</label>
                    <input type="text" name="certi_name" id="certi_name" class="form-control" value="<?php echo $row['Certi_Name']; ?>" required>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <select name="from_month" id="from_month" class="form-control" required>
                        <option selected hidden><?php echo $row['From_Month']; ?></option>
            ...
            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <select name="from_year" id="from_year" class="form-control" required>
                        <option selected hidden><?php echo $row['From_Year']; ?></option>
                        <?php
                        $currentYear = date("Y");
            ...
            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <select name="to_month" id="to_month" class="form-control" required>
                        <option selected hidden><?php echo $row['To_Month']; ?></option>
                        <option value="">Select Month</option>
                        <option value="Present">Present (No Expiration)</option>
                        <option value="January">January</option>
                        <option value="February">February</option>
                        <option value="March">March</option>
                        <option value="April">April</option>
            ...
            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <select name="to_year" id="to_year" class="form-control" required>
                        <option selected hidden><?php echo $row['To_Year']; ?></option>
                        <option value=" (No Expiration)">Present (No Expiration)</option>
                        <?php
                        $currentYear = date("Y");
                        for ($year = $currentYear; $year >= 1950; $year--) {
                            echo "<option value='$year'>$year</option>";
            ...
            <div class="col-lg-12">
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <textarea name="textarea" id="default" class="form-control" rows="3"><?php echo $row['Description']; ?></textarea>
                </div>

              <button class="submit-btn1" type="submit" id="submit" name="submit" form="form_body">Save</button>

              <button class="delete-btn1" id="deletedata" name="deletedata" form="form_body">Delete</button>
              
              
              <a href="Alumni-Resume-AddCerti.php"><button class="delete-btn1" style="float: right; background-color: #6C5E19;" type="button" onmouseover="this.style.backgroundColor='#2C5F3D';" 
            onmouseout="this.style.backgroundColor='#6C5E19';">Add Other</button></a>
