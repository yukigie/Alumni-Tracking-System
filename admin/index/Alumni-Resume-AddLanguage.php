...
if (isset($_POST['submit'])) {
    ...
    // Insert Data
    $query = "INSERT INTO tbl_alumni_language (Language, Proficiency, Email) 
              VALUES ('{$language}', '{$proficiency}', '{$email}')";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <form action="Alumni-Resume-AddLanguage.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 10px;">
                ...
                <select name="proficiency" id="proficiency" class="form-control" required style="margin-top: 10px;">
                  <option selected hidden value="">Select Proficiency</option>
