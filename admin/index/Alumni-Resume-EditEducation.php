...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tbl_alumni_education 
              SET Level = '{$level}', 
              Field = '{$field}',
              School_Name = '{$school}', 
              City = '{$city}', 
              ...
              To_Month = '{$to_month}', 
              To_Year = '{$to_year}'
              WHERE ID = '{$educ_id}' AND Email = '{$email}'";
...
if ( isset($_POST['deletedata']) ){
        ...
        $sql = "DELETE FROM tbl_alumni_education WHERE ID=$educ_id AND Email = '{$email}'";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <form action="Alumni-Resume-EditEducation.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
      ...
      <?php
        ...
        if ($id) {
            ...
            $query = "SELECT * FROM tbl_alumni_education WHERE ID ='$id' AND Email ='$email'";
            $query_run = mysqli_query($con, $query);
            $check_data = mysqli_num_rows($query_run) > 0;
        ...
        <div class="row justify-content-center">
          ...
          <input type="hidden" name="educ_id" id="educ_id" class="form-control" value="<?php echo $row['ID']; ?>" required>

            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 20px;">
                    <label>Level of Education*</label>
                    <select name="level" id="level" class="form-control" required style="margin-top: 10px;">
                        <option selected hidden><?php echo $row['Level']; ?></option>
            ...
            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <input type="text" name="field" id="field" class="form-control" value="<?php echo $row['Field']; ?>">
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="form-group" style="margin-top: 20px;">
                    ...
                    <input type="text" name="school" id="school" class="form-control" value="<?php echo $row['School_Name']; ?>" required>
                </div>
            </div>
            ...
            <div class="col-lg-12">
              ...
              <a href="Alumni-Resume-AddEducation.php"><button class="delete-btn1" style="float: right; background-color: #6C5E19;" type="button" onmouseover="this.style.backgroundColor='#2C5F3D';" 
