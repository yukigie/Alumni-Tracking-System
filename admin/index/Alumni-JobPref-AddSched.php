...
if (isset($_POST['submit'])) {
    ...
    $check = mysqli_query($con, "SELECT * FROM tbl_alumni_jobprefsched WHERE Schedule='$sched' AND Email='$email'");
    
    if (mysqli_num_rows($check) > 0) {
        alert("Already Exist!", "The Schedule You Entered Is Already On The List!", "warning");
    } else {

    // Insert Data
    $query = "INSERT INTO tbl_alumni_jobprefsched (Schedule, Email) 
              VALUES ('{$sched}', '{$email}')";
    ...
    if (mysqli_query($con, $query)) {
        ...
        alert("Data Not Updated!", "Failed to update Your Job Preference Details.", "error");
        exit;
        }
    }
}
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        <a href="Alumni-JobPreference.php" style="margin-top: -10px;"><span><i class='bx bx-chevron-left'></i></span> Return to Job Preferences</a>
        <div class="profile_content" style="margin-top: 20px;">
        <h5>What are your desired Schedules?</h5>
        <form action="Alumni-JobPref-AddSched.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 10px;">
                ...
                <select name="sched" id="sched" class="form-control" required style="margin-top: 10px;">
                  <option selected hidden value="">Select Schedule</option>
