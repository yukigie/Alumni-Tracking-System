...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE tbl_alumni_link 
              SET Link = '{$link}'
              WHERE ID = '{$link_id}' AND Email = '{$email}'";
...
if ( isset($_POST['deletedata']) ){
        ...
        $sql = "DELETE FROM tbl_alumni_link WHERE ID=$link_id AND Email = '{$email}'";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <h5>Link<span><i class='bx bxs-edit' ></i></span></h5>
        <p style="font-size: 13px; color: red;">*Please Fill Out All Fields</p>
        <form action="Alumni-Resume-EditLink.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
      ...
      <?php
        ...
        if ($id) {
            ...
            $query = "SELECT * FROM tbl_alumni_link WHERE ID ='$id' AND Email ='$email'";
            $query_run = mysqli_query($con, $query);
            $check_data = mysqli_num_rows($query_run) > 0;
        ...
        <div class="row justify-content-center">
          ...
          <input type="hidden" name="link_id" id="link_id" class="form-control" value="<?php echo $row['ID']; ?>" required>
            ...
            <div class="col-lg-12">
              ...
              <a href="Alumni-Resume-AddLink.php"><button class="delete-btn1" style="float: right; background-color: #6C5E19;" type="button" onmouseover="this.style.backgroundColor='#2C5F3D';" 
