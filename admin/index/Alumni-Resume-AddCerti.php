...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tbl_alumni_certification (Certi_Name, From_Month, From_Year, To_Month, To_Year, Description, Email) 
              VALUES ('{$certi_name}', '{$from_month}', '{$from_year}', '{$to_month}', '{$to_year}', '{$textarea}', '{$email}')";
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        ...
        <form action="Alumni-Resume-AddCerti.php" method="POST" enctype="multipart/form-data" class="form_body" id="form_body" autocomplete="off">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 20px;">
                ...
                <input type="text" name="certi_name" id="certi_name" class="form-control" required>
              </div>
            </div>

            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 20px;">
                <h6>(Time Period) From:</h6>
              </div>
            </div>
            ...
            <div class="col-lg-12">
              <div class="form-group" style="margin-top: 20px;">
                ...
                <textarea name="textarea" id="default" class="form-control" rows="3"></textarea>
              </div>
            </div>
