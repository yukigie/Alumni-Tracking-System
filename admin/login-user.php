    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 form login-form">
                ...
                <center>
                    <img src="admin_img/logo-orange.png">
                    <h3 class="text-center">Cavite State University</h3>
                    <h6>IMUS CAMPUS</h6>
                    <h3 class="text-center subtext">Alumni Tracker</h3>

                    <p class="text-center subtext1">Admin Access <i class="fa fa-user-circle" aria-hidden="true"></i></p>
                </center>
                
                <label class="signin-label">Sign In</label>
                <hr>
                <label class="signin-label1">Enter your email and password to Sign in as <b>Admin</b>!</label>


                <label style="font-weight: 600; color: #f9f9f9;">Email <span class="req">*</span></label>
                <center><div class="form-group">
                    <input type="email" name="email" placeholder="Email Address" required autocomplete="off" value="<?php echo $email ?>">
                </div></center>

                <label style="margin-top: 20PX; font-weight: 600; color: #f9f9f9;">Password <span class="req">*</span></label>
                <center><div class="form-group">
