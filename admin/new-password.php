            ...
            <div class="col-md-4 offset-md-4 form">
                <form action="new-password.php" method="POST" autocomplete="off" onsubmit="return validateFirstPage()">
                    ...
                    <div class="errormsg" style="margin-left: -10px;">
                      <label id="password_error" style="font-size: 12px; color: red; padding-top: 10px; padding-bottom: 10px; display: none;"></label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="errormsg" style="margin: -10px;">
                      <label id="cpassword_error" style="font-size: 12px; color: red;"></label>
                    </div>
                    <div class="form-group">
