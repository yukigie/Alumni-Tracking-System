...
<head>
    ...
    <title>Alumni | Print Job Alignment</title>
...
<div class="row">
    ...
    <div id="personal_details" style="padding-top: 20px;">
        <a href="Print-JobMatch.php" style="margin-top: -10px; color: #C2AE44"><span><i class='bx bx-chevron-left'></i></span> Return to Table</a>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6">
              <div class="form-group" style="margin-top: 10px;">
                ...
                <select name="filter_alignment" id="filter_alignment" class="form-control" style="margin-top: 35px; display: none; width: 85%;">
                    <option hidden selected>Select Alignment</option>
...
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Alumni ID</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">First Name</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Last Name</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Gender</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Course</th>
...
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Position</th>
...
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Emp. Type</th>
<th style="border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; background-color: green; color: white;">Job Alignment</th>
</tr>
...
// Base query to fetch alumni and their job statuses
$query = "SELECT 
            a.Alumni_ID, a.First_Name, a.Last_Name, a.Gender, a.Course, a.Batch_Year, 
            j.Job_Name, j.Date_Hired, j.Company_Name, j.Employment_Type, j.Job_Type, j.Status
          FROM 
            tbl_alumni a
          INNER JOIN 
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <tr>
        ...
        <td style='border: 1px solid #ddd; padding: 8px;'>{$row['Alumni_ID']}</td>
        ...
        <td style='border: 1px solid #ddd; padding: 8px;' class='course-column'>{$row['Course']}</td>
        <td style='border: 1px solid #ddd; padding: 8px;'>{$row['Batch_Year']}</td>
        <td style='border: 1px solid #ddd; padding: 8px;'>{$row['Job_Name']}</td>
        <td style='border: 1px solid #ddd; padding: 8px;'>{$row['Date_Hired']}</td>
        <td style='border: 1px solid #ddd; padding: 8px;'>{$row['Company_Name']}</td>
        <td style='border: 1px solid #ddd; padding: 8px;'>{$row['Employment_Type']}</td>
        <td style='border: 1px solid #ddd; padding: 8px;'>$alignment</td>
    </tr>";
    $no++;
}
mysqli_close($con);
...
document.getElementById('filter_type').addEventListener('change', function () {
    ...
    document.querySelectorAll('#filter_gender, #filter_course, #filter_year, #filter_status, #filter_comp, #filter_place, #filter_alignment, #submit').forEach(el => {
    ...
    else if (selectedCategory === 'alignment') document.getElementById('filter_alignment').style.display = 'inline-block';
...
document.getElementById('submit').addEventListener('click', function () {
    ...
    else if (filterType === 'alignment') filterValue = document.getElementById('filter_alignment').value;

    if (filterType && filterValue) {
        // Send an AJAX request
        const xhr = new XMLHttpRequest();
        xhr.open("POST", "filter_alignment.php", true);
